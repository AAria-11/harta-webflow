...
function createAndDisplayCard(clickedFeature, adjustMap = true) {
    ...
    addressIcon.src = `https://cdn.jsdelivr.net/gh/AAria-11/harta-webflow@main/pins/${iconPaths[category]}_normal.png`;
...
function openReadMore(elementOrFeatureName) {
  ...
  addressIconReadMore.src = `https://cdn.jsdelivr.net/gh/AAria-11/harta-webflow@main/pins/${iconPaths[categoryName]}_normal.png`;
